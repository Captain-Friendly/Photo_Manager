    ...
    public static class UsersDBDAL
    {
        ...
        public static bool RemoveUser(this UsersDBEntities DB, int userId)
        {
            ...
            if (userToDelete != null)
            {
                ...
                DB.DeleteRatings(userId);
                DB.DeletePhotos(userId);
                DB.DeleteLogins(userId);
        ...
        public static bool DeleteRatings(this UsersDBEntities DB, int userId)
        {
            DB.PhotoRatings.RemoveRange(DB.PhotoRatings.Where(u => u.UserId == userId));
            DB.SaveChanges();
            return true;
        }
        public static bool DeleteLogins(this UsersDBEntities DB, int userId)
        {
        ...
        public static bool DeletePhotos(this UsersDBEntities DB, int userId)
        {
            var userPhotos = DB.Photos.Where(u => u.UserId == userId);
            ...
            DB.Photos.RemoveRange(DB.Photos.Where(u => u.UserId == userId));
            DB.SaveChanges();
            return true;
        }
        ...
        {
            PhotoRating existingPhotoRating = DB.PhotoRatings.Where(pr => pr.PhotoId == photoRating.PhotoId && pr.UserId ==
            photoRating.UserId).FirstOrDefault();
